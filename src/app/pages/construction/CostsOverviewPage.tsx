    ...
    >
      <div>
        ...
        <p className="text-sm mt-1" style={{ color: "#718096" }}>
          Cost summary across all projects
        </p>
      </div>
              ...
              {filtered.map((pc, i) => {
                ...
                return (
                  <tr
                    ...
                    onClick={() =>
                      navigate(`/apps/construction/projects/${pc.id}/costs`)
                    }
                  >
                    ...
                    <td
                      ...
                      style={{
                        color: pc.utilisation > 90 ? "#E74C3C" : "#1A202C",
                      }}
                    >
                      {pc.utilisation}%
                    </td>
                    <td
                      className="px-4 py-3 text-right font-medium"
                      style={{ color: isOver ? "#E74C3C" : "#27AE60" }}
                    >
                      {isOver ? "-" : "+"}
                      {fmtCurrency(Math.abs(pc.variance))}
                    </td>
