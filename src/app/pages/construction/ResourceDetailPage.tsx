  ...
  return (
    <div style={{ backgroundColor: "#F7F8FA" }} className="min-h-screen p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        {/* Left Column — Info + Work Packages */}
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="rounded-xl border p-5" style={{ borderColor: "#E2E8F0", backgroundColor: "white" }}>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="px-2 py-0.5 rounded text-xs font-medium" style={{ backgroundColor: "#F7F8FA", color: "#E8973A" }}>
                {workPackages.length}
              </span>
            </div>
            {workPackages.length === 0 ? (
              <p className="text-sm text-gray-400 py-4 text-center">No work packages assigned</p>
            ) : (
