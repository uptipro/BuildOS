...
```typescript
// WRONG (lines 78, 104)
include: { instance: true }  // ❌ Wrong relation name

// CORRECT
include: { workflowInstance: true }  // ✅ Matches schema relation
```
...
```typescript
// WRONG (line 55)
orderBy: { sequence: 'asc' }  // ❌ Doesn't exist

// CORRECT
orderBy: { nodeSequence: 'asc' }  // ✅ Uses actual field
```
